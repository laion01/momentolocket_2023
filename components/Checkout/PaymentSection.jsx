        ...
        <div className="w-full flex flex-col">
            ...
            <div className="bg-white flex flex-col p-[1.5rem] rounded-[0.5rem] shadow mb-[2rem]">
                ...
                <div className="flex items-center w-full mb-[1rem]">
                    <PaymentForm
                        applicationId="sandbox-sq0idb-qw-sMR11PiGsC5O0V0Huow"
                        cardTokenizeResponseReceived={async (token, verifiedBuyer) => {
                            try {
                                const response = await fetch("/api/checkout/squarecharge", {
                                    method: "POST",
                                    headers: {
                                ...
                                router.push(`/order?id=${res.order.id}`)
                            } catch (e) {

                            }
                        }}
                        locationId='LMDE18FVY30GG'
                    >
                        {/* <ApplePay />
                        <GooglePay /> */}
                        <CreditCard />
